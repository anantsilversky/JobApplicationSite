        ...
        <div class="card-body">
            <div style="display: flex">
                <div class="card" style="padding-left: 4%; border: none; padding-top: 4%; padding-bottom: 4%; width: 60%">
                    ...
                    <br>
                    <h4>DOB : <span style="font-size: 80%; margin-left:3%">{{$user->dob}}</span></h4>
                    <br>
                    <h4>Address : <span style="font-size: 80%; margin-left:3%">{{$user->address}},{{$user->city}}, {{$user->pincode}}</span></h4>
                    <br>
                    <h4>Contact : <span style="font-size: 80%; margin-left:3%">{{$user->phone}}</span></h4>
                    <br>
                    <h4>Gender : <span style="font-size: 80%; margin-left:3%">{{$user->gender}}</span></h4>
                </div>
